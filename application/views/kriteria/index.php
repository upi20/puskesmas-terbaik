								...
								foreach ($kriteria as $item) { ?>
									<tr>
										...
										<td>
											...
											<button type="button" class="btn btn-warning btn-xs" onclick="edit_kriteria(<?php echo $item->kdKriteria; ?>)">
												<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Ubah Kriteria
											</button>

											<button type="button" class="btn btn-primary btn-xs" onclick="edit_item_kriteria(<?php echo $item->kdKriteria; ?>)">
